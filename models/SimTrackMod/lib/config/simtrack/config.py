...
cfg.MODEL.CLASSIFICATION = edict()
cfg.MODEL.CLASSIFICATION.ENABLED = False
cfg.MODEL.CLASSIFICATION.NUM_CLASSES = 10
cfg.MODEL.CLASSIFICATION.HIDDEN_DIM = 512
...
cfg.TRAIN.CLS_WEIGHT = 0.1
cfg.TRAIN.TRAIN_CLS_HEAD = False
cfg.TRAIN.PRETRAINED_WEIGHTS = ""
cfg.TRAIN.MAX_SAMPLES_PER_SEQ = 500
cfg.TRAIN.VAL_SPLIT = 0.2
cfg.TRAIN.SEED = 59
# TRAIN.SCHEDULER
