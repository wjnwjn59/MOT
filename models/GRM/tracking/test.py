...
def main():
    ...
    parser.add_argument('--num_gpus', type=int, default=1, help='num of GPUs you want to use')
    ...
    run_tracker(args.tracker, args.param, args.id, args.dataset, seq_name, args.debug, args.threads,
