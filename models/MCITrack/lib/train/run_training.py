...
def main():
    parser = argparse.ArgumentParser(description='Run a train script in train_settings.')
    ...
    parser.add_argument('--script_teacher', type=str)
    parser.add_argument('--config_teacher', type=str)

    args = parser.parse_args()

    # Set GPU device (assuming GPU 0)
