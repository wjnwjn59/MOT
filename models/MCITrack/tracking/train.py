...
def parse_args():
    ...
    parser.add_argument('--config', type=str, default='baseline_got', help='yaml configure file name')
    ...
    parser.add_argument('--nproc', type=int, default='1', help='number of GPUs per node')  # Specify when mode is multiple
